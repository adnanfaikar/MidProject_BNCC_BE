                ...
                <div class="card-body">
                    <form method="post" action="{{ route('createForm') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="halamana" type="number" class="form-control" name="halaman" placeholder="Halaman Buku" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tahun_terbit" type="number" class="form-control" name="tahun_terbit"placeholder="Tahun Terbit Buku" >
                                @error('tahun_terbit')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
